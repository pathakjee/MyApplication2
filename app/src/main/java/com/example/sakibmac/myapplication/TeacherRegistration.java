...
public class TeacherRegistration extends Fragment implements View.OnClickListener {

    EditText name, address,birthday, password, confirmPass, email, mobile;
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (radioCheckedId == 2) {
                    ...
                    Toast.makeText(getActivity(), "Please choose a gender.",
        ...
        if (!checkImage) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    String names = name.getText().toString().trim();
                    String addresss = address.getText().toString().trim();
                    String dates = birthday.getText().toString().trim();
